...
const badges = [
  '✓ ISO Certified', '✓ FDA Approved', '✓ GMP Certified', '✓ 100% Ayurvedic',
...
export default function ProductTransition() {
  return (
    <section className="py-24 relative overflow-hidden" style={{ background: 'linear-gradient(135deg, #FDF2F8 0%, #FCE7F3 50%, #FFF1F2 100%)' }}>
